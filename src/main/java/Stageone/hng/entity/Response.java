...
public class Response {
    ...
    public Response(String slack_name, String current_day, String utc_time, String track, String github_file_url, String github_repo_url, int status_code) {
